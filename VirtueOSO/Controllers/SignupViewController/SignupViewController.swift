...
class SignupViewController: UIViewController {
    ...
    private func initializeSubviews() {
        ...
        verticalStackView.addTextToStack("Make sure it matches the name on your government ID")
        verticalStackView.addArrangedSubview(EmptySpaceView(20))
        verticalStackView.addArrangedSubview(birthdateTextField)
        verticalStackView.addArrangedSubview(EmptySpaceView(5))
        verticalStackView.addTextToStack("To sign up, you need to be at least 18. Your birthday won’t be shared with other people who use Airbnb.")
        verticalStackView.addArrangedSubview(EmptySpaceView(20))
        verticalStackView.addArrangedSubview(emailTextField)
        verticalStackView.addArrangedSubview(EmptySpaceView(5))
        verticalStackView.addTextToStack("We'll email you trip confirmations and receipts.")
        verticalStackView.addArrangedSubview(EmptySpaceView(20))
