...
extension UIImage {
    ...
    public enum SFSymbol: String {
        ...
        case chevronCompactTop = "chevron.compact.top"
        case chevronCompactRight = "chevron.compact.right"
        case chevronCompactBottom = "chevron.compact.bottom"
        case clock = "clock"
        ...
        case ellipses = "ellipsis"
        case ellipsesCircle = "ellipsis.circle"
        case ellipsesCircleFill = "ellipsis.circle.fill"
        case ellipsesBubble = "ellipsis.bubble"
        case ellipsesBubbleFill = "ellipsis.bubble.fill"
        case eye = "eye"
