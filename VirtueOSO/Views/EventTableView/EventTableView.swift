...
class EventTableView: UITableView {
    ...
    var eventDelegate: EventTableViewDelegate?
    ...
    private func initialize() {
        ...
        delegate = self
        dataSource = self
        register(EventTableViewCell.self, forCellReuseIdentifier: EventTableViewCell.reuseIdentifier)
...
extension EventTableView: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        ...
        eventDelegate?.eventTableView(self, header: header, viewForHeaderInSection: section)
        return header
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        eventDelegate?.eventTableView(self, cell: cell, cellForRowAt: indexPath)
        return cell
    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        eventDelegate?.eventTableView(self, didSelectRowAt: indexPath)
    }
}
